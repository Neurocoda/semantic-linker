...
export function normalizeSettings(raw: Partial<PluginSettings> | null | undefined): PluginSettings {
	return {
		...
		graphDisplay: {
			...
			showLinkedNodes: booleanSetting(raw?.graphDisplay?.showLinkedNodes, DEFAULT_SETTINGS.graphDisplay.showLinkedNodes),
			showCandidateNodes: booleanSetting(raw?.graphDisplay?.showCandidateNodes, DEFAULT_SETTINGS.graphDisplay.showCandidateNodes),
